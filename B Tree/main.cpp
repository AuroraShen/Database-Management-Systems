...
void test5_negative_val();
void test6_non_leaf_split();
void test7_out_of_bound();
void test8_sized_relation_forward();
void test9_sized_relation_backward();
void test10_sized_relation_random();
void errorTests();
void deleteRelation();
...
int main(int argc, char **argv)
{
  ...
  try
    ...
    test4_empty_tree();
    test5_negative_val();
    test6_non_leaf_split();
    test7_out_of_bound();
    test8_sized_relation_forward();
    test9_sized_relation_backward();
    test10_sized_relation_random();
    errorTests();

  return 1;
}
/**
 * Given test1 for testing create Relation Forward
 */
void test1()
{
...
/**
 * Given test2 for testing create Relation Backward
 */
void test2()
{
...
/**
 * Given test3 for testing create Relation Random
 */
void test3()
{
...
/**
 * Self designed test4 for testing the case of empty tree
 * Similar test to the intTests
 */
void test4_empty_tree()
{
...
/**
 * Self designed test5 for testing the case of negative value
 * Similar test to the intTests
 */
void test5_negative_val()
{
...
/**
 * Self designed test6 for testing the case of non leaf node splitting
 */
void test6_non_leaf_split()
{

    std::cout << "-------------------" << std::endl;
    std::cout << "Test Non Leaf Split" << std::endl;
    const int size= 62500;
...
/**
 * Self designed test7 for testing the case of index out of bound
 */
void test7_out_of_bound(){
    std::cout << "-----------------" << std::endl;
    std::cout << "Test Out Of Bound" << std::endl;
    createRelationRandom();
    BTreeIndex index(relationName, intIndexName, bufMgr, offsetof(tuple, i),
                     INTEGER);

    checkPassFail(intScan(&index, 900000, GTE, 500000, LT), 900000);
    checkPassFail(intScan(&index, 989923, GTE, 238324, LT), 234);
    checkPassFail(intScan(&index, 965435, GTE, 6000, LT), 0);
    checkPassFail(intScan(&index, -569098, GT, 0, LT), 0);
    checkPassFail(intScan(&index, -569098, GT, 7, LTE), 10);
    deleteRelation();
}

/**
 * Self designed test8 for testing the creat relation forward with given size
 */
void test8_sized_relation_forward()
{
    // Create a relation with tuples valued 0 to relationSize and perform index tests
    // on attributes of all three types (int, double, string)
    std::cout << "--------------------------" << std::endl;
    std::cout << "createSizedRelationForward" << std::endl;
    createRelationForward(1600);
    indexTests();
    deleteRelation();
}
/**
 * Self designed test9 for testing the creat relation backward with given size
 */
...
void test9_sized_relation_backward()
{
    ...
    // on attributes of all three types (int, double, string)
    std::cout << "---------------------------" << std::endl;
    std::cout << "createSizedRelationBackward" << std::endl;
    createRelationForward(1600);
    indexTests();
    deleteRelation();
}
...
/**
 * Self designed test10 for testing the creat relation random with given size
 */
void test10_sized_relation_random(){
    // Create a relation with tuples valued 0 to relationSize and perform index tests
    // on attributes of all three types (int, double, string)
    std::cout << "-------------------------" << std::endl;
    std::cout << "createSizedRelationRandom" << std::endl;
    createRelationForward(1600);
    indexTests();
    deleteRelation();
}
